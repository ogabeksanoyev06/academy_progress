<template>
  <div class="top-up-balance">
    ...
    <div class="cabinet__content">
      <div class="payment__methods-wrap mb-10">
        <div
          class="payment__methods-item mr-20"
          style="cursor: pointer"
          :class="[
            isMobileSmall ? 'pa-15' : 'pa-20',
            selectedPaymentType === 1 ? 'active' : '',
          ]"
  ...
  data() {
    return {
      ...
      clickRequest: {
        ...
        return_url: "http://miraman.uz/payment-history",
        card_type: "uzcard",
      },
    };
  },
